...
public function create($group_id = 2) { 
	...
	DB::insert('users', array(
		...
		'password' => base64_encode(password_hash($_POST['password'], PASSWORD_BCRYPT, array('COST' => 25))), 
		'full_name' => $full_name, 
		'email' => $_POST['email'], 
		'group_id' => $group_id, 
		'reg_ip' => $reg_ip, 
...
public function update() { 
	...
	if (isset($_POST['password']) && $_POST['password'] != '') { 
		$updates['password'] = base64_encode(password_hash($_POST['password'], PASSWORD_BCRYPT, array('COST' => 25)));
	}
